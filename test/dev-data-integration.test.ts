...
// Mock string schema for param validation
const MockStringSchema: StandardSchemaV1<unknown, string> = {
  "~standard": {
    ...
    validate: (value: unknown) => {
      ...
      return { value: String(value) }; // Coerce to string
    },
    ...
    it("should handle production mode gracefully", () => {
      ...
      try {
        const router = createLayeredRouter(testRoutes)(
          ...
          // Data layer should still work in production
          devLayer(),
        )(); // Dev layer should provide no-ops in production
